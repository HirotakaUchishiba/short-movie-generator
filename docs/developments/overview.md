...
- `2026-05-10_analyze-pipeline-conformance.md` — analyze pipeline 準拠アップデート計画
- `2026-05-10_architecture-mismatch-audit.md` — 設計 ↔ 実装の差分監査 + 修正履歴
- `2026-05-08_*` — Phase 0-4 実装記録
