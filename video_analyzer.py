...
- **pronunciation_hints は必ず lines[].pronunciation_hints の位置に書く** (scene 直下に scene.pronunciation_hints として書かない)。同じ読みを複数の line で繰り返してもよいので、line 単位で必要なものだけ各 line に直接書く
