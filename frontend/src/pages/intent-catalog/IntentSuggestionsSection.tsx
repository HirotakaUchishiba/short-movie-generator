...
//
// novel intent suggestions の一覧 + 採用 / 却下 / yaml snippet 取得 UI。
// `/intent-catalog#suggestions` のハッシュリンクで auto-scroll する機能も持つ。
// SuggestionCard と一緒に同 file (parent / child 関係)。
...
export function IntentSuggestionsSection() {
